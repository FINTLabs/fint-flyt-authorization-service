...
public class TokenParsingUtils {
    ...
    public String getObjectIdentifierFromToken(JwtAuthenticationToken jwtAuthenticationToken) {
        return jwtAuthenticationToken.getTokenAttributes().get(UserClaim.OBJECT_IDENTIFIER.getTokenClaimName()).toString();
    }
    ...
    public User getUserFromToken(JwtAuthenticationToken jwtAuthenticationToken) {
        ...
        return User
                .builder()
                .objectIdentifier(UUID.fromString(tokenAttributes.get(UserClaim.OBJECT_IDENTIFIER.getTokenClaimName()).toString()))
    ...
    public List<String> getRolesFromToken(JwtAuthenticationToken jwtAuthenticationToken) {
        return ((List<?>) jwtAuthenticationToken.getTokenAttributes().get(UserClaim.ROLES.getTokenClaimName()))
                .stream()
                .map(Object::toString)
                .toList();
    }
