...
public class ClientAuthorizationProducerRecordBuilder {
    ...
    public ReplyProducerRecord<ClientAuthorization> apply(ConsumerRecord<String, String> consumerRecord) {
        ...
        } else if (RiksantikvarenSourceApplication.CLIENT_ID != null && Objects.equals(consumerRecord.value(), RiksantikvarenSourceApplication.CLIENT_ID)) {
            log.debug("Request by client with id="+ RiksantikvarenSourceApplication.CLIENT_ID+". Returning source application id="+ RiksantikvarenSourceApplication.SOURCE_APPLICATION_ID);
            return buildReplyProducerRecord(RiksantikvarenSourceApplication.CLIENT_ID, RiksantikvarenSourceApplication.SOURCE_APPLICATION_ID);
        } else {
